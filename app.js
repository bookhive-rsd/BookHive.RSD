...
app.use(session({
  ...
  store: MongoStore.create({ mongoUrl: 'mongodb+srv://bookhiversd:8D6pLujBM9rLVi8B@bookhive.7h76ryz.mongodb.net/BookHive.RSD?retryWrites=true&w=majority&appName=BookHive' }),
  cookie: { 
...
// MongoDB connection
mongoose.connect('mongodb+srv://bookhiversd:8D6pLujBM9rLVi8B@bookhive.7h76ryz.mongodb.net/BookHive.RSD?retryWrites=true&w=majority&appName=BookHive', { 
